...
public class LedgerTransferValidator {
    public static List<ValidationError> validateTransferRequest(TransferRequestDTO transferRequestDTO) {
        ...
        if (transferRequestDTO.getTransferId() == null) {
            errors.add(new ValidationError("transferId", "transferId must not be null",null));
        }
